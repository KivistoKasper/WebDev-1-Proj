 ...
 *
 * @param {string} filePath file path to scene to be rendered
 * @param {http.ServerResponse} response response to be sent to the client
 * @returns {void} nothing if successful, 404 scene if something went wrong
 */
 ...
 *
 * @param {string} fileExtension file name extensions
